...
func newPreviewCleanupStepMachine() stepMachine {
	return newStepMachine(
...
var stepMachines = map[string]stepMachine{
	...
	TypePreviewDelete:            newPreviewCleanupStepMachine(),
	TypePreviewCleanupSuperseded: newPreviewCleanupStepMachine(),
}
