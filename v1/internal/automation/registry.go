...
const (
	...
	EventFamilyPullRequestUnlabeled      = "pull-request-unlabeled"
	...
	TriggerTypePreviewDeleteOnLabelPreviewRemoved = "preview_delete_on_label_preview_removed"
	TriggerTypePreviewOnCommentPreview            = "preview_on_comment_preview"

	HandlerPreviewStart             = "handle_preview_start"
	HandlerPreviewDelete            = "handle_preview_delete"
...
type OperationDefinition struct {
	...
	BuildTriggerIntentSnapshot func(operations.TriggerIntentSnapshotInput) ([]byte, error) `json:"-"`
}
